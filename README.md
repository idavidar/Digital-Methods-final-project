...
The selection of our total of 50 Twitter accounts gives us a corpus of roughly 10,000 tweets. 
- NB: INSERT TABLE WITH NUMBER OF TWEETS FOR EACH GROUP WHEN NEW DATASET IS FINAL
...
In the following paragraphs we will present the 10 most frequently used terms and hashtags used by each of the subgroups when discussing the abortion issue. Further, some of the most liked tweets from each of the corpuses are presented to try to illustrate the narratives in these tweets. 
