...
- Words included in the query: We tried to capture as many of the tweets made by these accounts about the abortion debate as possible. We did this by including more obvious terms such as “abortion” and “Roe” (referring to the specific Supreme Court decision) but also more general words (birth, pregnant etc.) that we assume to be related to this debate in our specific time period. We refined our query by making several changes, for instance by removing “Supreme Court” from the query, since we saw that some of the tweets extracted using this term referred to other decisions made by the Supreme Court which were not related to abortion. Based on the qualitative checks of tweets we collected, we felt quite confident that the words remaining in our query provide us with tweets which are relevant for our project. 
- Time period: We chose to scrape data spanning a period of 7 months, from a couple of days before the leak when news circulated that the Supreme Court was going to overturn Roe vs. Wade (May 1st) until the day of our analysis (16th of November). We chose this time period to see if there were some interesting developments in the debate over time. Further, abortion resurfaced as an important issue during the U.S. Midterm elections season in November. 
- Language: We scraped and analyzed tweets written only in English. 
### How did we chose our groups?
Our choice of Twitter accounts within each of our 5 different groups was dependent on several things. We searched the internet for relevant American groups/organizations within each of our 5 groups. Then we searched for these groups on Twitter and looked at a number of relevant factors, most importantly how many followers they had and how active they had been on Twitter in our time period (prioritizing accounts that actually tweet). We then chose the top 10 Twitter accounts we wanted to include within each of our groups (e.g. pro-choice, LGBTQ2S+, etc).
The selection of our total of 50 Twitter accounts gives us a corpus of roughly 10,000 tweets as can be seen in the table below:
...
- However, when we look at the corpuses within each of the subgroups, some of the corpuses are very small. Of course, both the pro-choice and pro-life groups have tweeted a lot on the issue of abortion within our time period since abortion is their main policy-focus (5672 and 3750 tweets respectively), and our search query captures around 50-60% of these groups' total tweets in the chosen time period.
- However, when looking at the remaining sub-groups (LGBTQ2S+, minority Groups and Christian religious Groups), there are very few tweets about the abortion issue within the chosen time period - these tweets only make up about 5-6% of the total number of tweets within this time period from the accounts. This is to be expected, since these organizations do not focus only on the abortion issue, so they seldom tweet about abortion unless there are big events such as the day of the overturning of Roe v. Wade (but maybe then not that much afterwards). 

## Analysis approach

Our analysis consist of two different parts. In the first part of the analysis we work with 5 different data corpuses representing our five different subgroups. Within each of these 5 corpuses we did several analyses to show the framing of the abortion issue from the specific groups. We first extracted the top 100 terms (monograms forbidden) and hashtags used in the groups’ tweets about abortion. We then manually cleaned up these list making sure that there were no duplicates and putting together terms that were clearly connected but not captured initially by Cortext (e.g. "#Roevwade" and "#Roevswade"). We then also extracted the top 10 tweets made in each of the corpuses based on the number of likes the tweets got. This data will be used to say something about how the different subgroups discuss and frame the abortion debate, and will make it easy to see if some of the groups use similar/very different framings.

In the second part of our analysis we combined the 5 corpuses together to one corpus. The purpose of this is to show even clearer how the 5 different subgroups are connected through their framing of the abortion issue. We did this by creating a network map showing graphically how the different groups are connected through their use of different terms and hashtag in their tweets about abortion. 

In the following paragraphs we will start of by showing the first part of our analysis - presenting the 10 most frequently used terms and hashtags used by each of the subgroups when discussing the abortion issue. Further, some of the most liked tweets from each of the corpuses are presented to try to illustrate the narratives in these tweets. Afterwards we will move towards the second part of our analysis. 
...
When moving on to the top 10 most frequent hashtags from the Pro-Choice groups there is again a clear focus on freedom, which is obviously an essential aspect of the abortion discussion that pro-choice groups often highlight. This can be seen in the 3 most frequent hashtags #fightbackforfreedom, #bansoffourbodies and #reprofreedomvoter. Then again there is also clearly some use of hashtags linking the tweets to the specific case such as #scotus, #roevwade and #roe. Furthermore, there on of the most frequently used hashtags are #whpa which refers to the socalled [Women's Health Protection Act](https://actforwomen.org/the-womens-health-protection-act/). The WHPA is a piece of federal legislation proposed by the House of Representatives multiple times the last 10 years trying to expand the abortion rights established in Roe vs. Wade to protect the right to access abortion care throughout the US, even in case of an overturnment of Roe vs. Wade. The WHPA was proposed by Democrats in the House and passed through the House (which had a Democratic majority) in early 2022, but was rejected by the Senate (which did not have a Democratic majority) in both February and on May 3rd 2022 - the same day of the leaked draft from the Supreme Court. The organizations use this hashtag in tweets both right when the WHPA was blocked by the Senate, but also throughout our entire period of investigation to highlight how important it is, to vote Democratic in the midterms election in November, since this could flip the majority in the Senate and making the WHPA possible to pass. This can for instance be seen in this specific tweet på the organization NARAL Pro-Choice America, who tweeted the following on July 15th:
