...
The most frequently used term by these group is "pregnancy centers" which refers to pregnancy resource centers (sometimes also known as pro-life pregnancy centers), established by anti-abortion groups to persuade pregnant women to chose other options than abortion by providing support, guidance, diapers etc. In pro-life group tweets, these centers are often mentioned as a response to the critisism that 'pro-lifers' do not give options to pregnant women. In relation to this, a lot of these tweets also refer to specific situations where pro-choice demonstrators have blocked or vandalized these pregnancy centers around the US, as a reaction to _Roe_ being overturned. A last term worth mentioning is "human life," which is also key to understanding the different stances of the pro-choice and pro-life organizations. An important argument for the pro-life stance is that an unborn fetus should be considered a human life with rights on equal terms with the pregnant mother already from conception. 
...
<img width="783" alt="Capture d’écran 2022-12-22 à 06 52 12" src="https://user-images.githubusercontent.com/115983366/209066531-aa86ac7d-85d8-4340-8d88-e909e1cc3413.png">

The contingency matrix above showcases the joint distribution of the two variables, namely the top 10 terms and top 10 hashtags in the corpus. The corpus for this analysis was composed of the Tweets from all 5 groups (i.e. all 50 Twitter accounts). The number of nodes selected was restricted to 10, keeping the table easy to interpret while also highlighting the top terms and hashtags that have a stronger correlation. To ensure that smaller deviations are not overshadowed by the larger deviations, and to make the comparison between the contingency matrix blocks easier, the log scale was added during the analysis stage on Cortext. Further, the parameters of the script were set such that the statistically insignificant blocks have been crossed out (i.e. where the p-value is larger than 0.05 and the correlation is not significant, a cross marks the cell block). 

Some interesting correlations can be seen in the matrix, which also reflect and support the above analysis. There are several dark red blocks indicating a high correlation between terms such as "pregnancy centres" and hashtags such as "#cantstaysilent." Some of the correlations might be expected and may even seem intuitive. For insntance, tweets mentioning the terms "supreme court" also mention "#scotus" and "#roevwade" more frequently. However, one interesting finding is that the hashtag "#prolife" does not have a statistically significant correlation with either of the top 10 terms listed in the matrix. On the other hand, the term "abortion rights" has a significant positive correlation only with the hashtag "#abortionisessential." Broadly speaking, the matrix shows a general pattern that specific terms and hashtags tend to appear together very frequently, however in a smaller number of Tweets within our corpus. This also shows that users who frame the issue from a particular angle tend to use terminologies and hashtagsthat are very specific to their perspective. For instance, , Tweets that use the terms "reproductive freedom" tend to also include hashtags that only refer to freedom (e.g. #reprofreedomvoter and #fightbackforfreedom).   
